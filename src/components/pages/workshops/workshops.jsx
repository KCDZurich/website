...
const Workshops = () => (
  <section className="safe-paddings relative bg-gray-12 pt-40 lg:pt-32 md:pt-24 sm:pt-16">
    <div className="container flex justify-between lg:flex-col-reverse">
      ...
      <div className="text-primary-1">
        ...
        <p className="mt-5 max-w-[592px] text-xl leading-normal lg:max-w-[700px] ">{DESCRIPTION}</p>
