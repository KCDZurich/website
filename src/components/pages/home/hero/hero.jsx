...
const Hero = () => (
  <section className="safe-paddings relative">
    <div className="container py-40 lg:!px-12 lg:py-[88px] md:flex md:flex-col md:items-center md:text-center">
      <span className="ml-1 text-xl font-medium leading-normal text-white">
        // conference <time dateTime="2024-06-13">{dateString}</time>
      </span>
      <h1 className="mt-3 max-w-[480px] font-sans-cyber text-[72px] font-extrabold leading-denser tracking-tight text-primary-1 lg:max-w-[400px] lg:text-[64px] sm:text-7xl">
        {title}
      </h1>
      <p className="mt-4 max-w-[440px] text-base font-medium leading-relaxed text-primary-1">
        {description}
      </p>
    ...
    <StaticImage
      className="!absolute -top-[72px] left-1/2 -z-10 w-[1680px] -translate-x-1/2 lg:-top-[60px] lg:w-[1370px]"
