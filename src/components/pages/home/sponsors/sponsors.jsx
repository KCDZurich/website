...
const Sponsors = () => (
  <section className="safe-paddings relative pt-[113px] lg:pt-4 md:pt-6 xs:pt-8" id="sponsors">
    <div className="container-xl bg-blue-light bg-opacity-90">
      <div className="container flex items-center gap-x-20 py-[72px] lg:gap-x-16 lg:!px-4 lg:py-12 md:gap-x-4 md:!px-2 md:py-14 xs:flex-col-reverse xs:!px-0">
        <div className="text-2xl leading-normal text-primary-1 lg:text-base md:text-sm xs:text-base">
          ...
          <p className="mt-4 lg:mt-3 xs:mt-5">
          ...
          <Button
            className="!h-13 mt-9 !px-10 lg:mt-12 md:mt-6 xs:mt-8"
