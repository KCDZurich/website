...
const Venue = () => (
  <section className="safe-paddings pt-24 lg:pt-16 md:pt-10">
    <div className="container flex gap-x-36 lg:gap-x-10 md:gap-x-4">
      <div className="max-w-[270px] shrink-0 md:max-w-[220px]">
        <h2 className="font-sans-cyber text-[52px] font-bold leading-tight lg:text-[40px] md:text-[36px]">
          What is KCD?
        </h2>
      </div>
