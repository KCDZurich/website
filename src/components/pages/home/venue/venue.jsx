...
const Venue = () => (
  <section className="safe-paddings pt-24 lg:pt-16 md:pt-16 xs:pt-12">
    <div className="container flex gap-x-36 lg:gap-x-10 md:gap-x-4 xs:flex-col xs:gap-y-3">
      ...
      <div className="text-2xl leading-normal text-primary-1 lg:text-xl md:text-base">
        ...
        <p className="mt-6 md:mt-4">
          ...
          on{' '}
          <Link
            className="ml-3 inline-flex items-center border-b-2 border-transparent pb-0.5 font-mono-cyber text-[27px] font-bold leading-none tracking-wide transition-colors duration-200 hover:border-primary-1 lg:text-[24px] md:ml-1 md:text-lg sm:ml-2"
            to="/archive"
          >
