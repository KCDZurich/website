  ...
  <section className="safe-paddings relative">
    <div className="mx-auto max-w-[1696px] overflow-hidden">
      <div className="bg-inner-hero-gradient pb-[136px] pt-[104px] text-center text-xl leading-normal md:py-20 xs:py-11">
        ...
        <div className="relative mx-auto mt-14 w-[1336px] lg:left-1/2 lg:-translate-x-1/2 md:w-[1060px]">
          <img
          ...
          />
          <span className="absolute bottom-28 left-[525px] z-10 block font-mono-cyber text-5xl font-bold uppercase leading-normal md:bottom-[88px] md:left-[404px] md:text-4xl">
            freeasinbeer
          </span>
        </div>
