...
const DESCRIPTION =
  'Explore cloud native excellence at <b>KCD Zurich Rejects!</b>! Join expert speakers for talks, networking, and a vibrant celebration of innovation.';
...
const Speakers = () => {
  ...
  return (
    <section className="safe-paddings relative pt-24 lg:pt-16 md:pt-10 sm:pt-8">
